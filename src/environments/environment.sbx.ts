export const environment = {
  ...
  REQUEST_URI: "https://dome-certification-api.dome-marketplace-sbx.org/auth/oauth-token",
  REDIRECT_URI: "https://dome-certification.dome-marketplace-sbx.org/auth/login"
};
